...
export const slugify = (str) => {
  return str.replace(/ /g, "_"); // collapse whitespace and replace by underscore
};

export const slugReverse = (slug) => {
  return slug.replace(/_/g, " "); // collapse underscore and replace by whitespace
};
